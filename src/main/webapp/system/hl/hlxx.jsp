...
strSQL = "select count(*) from hltable";
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <tr> 
      <td height="6"><font color="#000000" size="2">汇率管理 &gt;&gt; </font>&nbsp;</td>
    ...
    <tr height="8" bgcolor="#d3d8eb"> <td width="285" height="8"> 
        <div align="left"><font color="#000000"><font size="2">货币名称</font></font>&nbsp;</div>
      </td>
      <td width="202" height="8"> 
        <div align="left"><font color="#000000"><font size="2">汇率</font></font>&nbsp;</div>
      </td>
      <td width="202" height="8"> 
   ...
   while(i<intPageSize && sqlRst.next()){ %>
    <tr height="8"onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      ...
      <td width="285" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div>
      </td>
      <td width="202" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(3)%> </font><font color="#000000" size="2"><a href="a-main-2.jsp" target="rbottom" style="font-size: 12px"> 
          </a></font>&nbsp;</div>
      </td>
      <td width="202" height="6"><font size="2"><%=sqlRst.getString(4)%></font>&nbsp;</td>
      <td width="202" height="6"> 
        <div align="center"><font color="#000000" size="2"> 
          <input type="button" value="编辑" name="B222" style="background-color: #E1E1E1; font-family: 宋体; font-size: 9pt; border: 1 groove #C3D9FF" onClick="window.open('edit-hl.jsp?id=<%=id%>','nw', 'height=446, width=1002, top=200, left=200, toolbar=yes, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no')">
          </font><font color="#000000" size="2"> 
          <input type="button" value="删除" name="B223" style="background-color: #E1E1E1; font-family: 宋体; font-size: 9pt; border: 1 groove #C3D9FF" onClick="window.open('del-hl.jsp?id=<%=id%>','nw', 'height=446, width=1002, top=200, left=200, toolbar=yes, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no')">
          </font>&nbsp;</div>
      </td>
    </tr>
    <% i++; } %>
