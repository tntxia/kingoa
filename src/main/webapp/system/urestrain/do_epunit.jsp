...
<div align="center"><br><br><br> <p><img src="../../images/cg.jpg" width="111" height="111"></p>
  ...
  <p style="font-size: 12px;"><a href="javascript:window.close()" style="font-size: 12px">关闭</a> <a href="punit.jsp" style="font-size: 12px">返回</a> </p>
</div>
</body>
<%}%>
</html>