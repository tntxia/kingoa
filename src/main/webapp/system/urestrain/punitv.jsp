...
<form name="form1" method="post" action="doeditpunit.jsp" onSubmit="return isValid();">
  <table width="100%" border="1" cellspacing="0" cellpadding="0" height="953">
    ...
    <tr> 
      ...
      <td width="16%"> <font size="2"> <strong><%=rs.getString("qzadd")%></strong> 
        </font>&nbsp;</td>
      <td width="17%"> <font size="2"> <strong><%=rs.getString("qzmod")%></strong> 
        </font>&nbsp;</td>
      <td width="14%"> <font size="2"> <strong><%=rs.getString("qzdel")%></strong> 
        </font>&nbsp;</td>
      <td width="15%"> <font size="2"> <strong><%=rs.getString("qzview")%></strong> 
        </font>&nbsp;</td>
      <td width="21%"> <font size="2"> <strong><%=rs.getString("qzzt")%></strong> 
        </font>&nbsp;</td>
    </tr>
    <tr> 
      <td width="17%"><b><font size="2" color="#000080">现有客户</font></b></td>
      <td width="16%"> <font size="2"> <strong><%=rs.getString("xhadd")%></strong> 
        </font>&nbsp;</td>
      <td width="17%"> <font size="2"> <strong><%=rs.getString("xhmod")%></strong> 
        </font>&nbsp;</td>
      <td width="14%"> <font size="2"> <strong><%=rs.getString("xhdel")%></strong> 
        </font>&nbsp;</td>
      <td width="15%"> <font size="2"> <strong><%=rs.getString("xhview")%></strong> 
        </font>&nbsp;</td>
      <td width="21%"> <font size="2"> <strong><%=rs.getString("xhzt")%></strong> 
        </font>&nbsp;</td>
    </tr>
    <tr> 
      <td width="17%"><b><font size="2" color="#000080">联系人</font></b></td>
      <td width="16%"> <font size="2"> <strong><%=rs.getString("linkadd")%></strong> 
        </font>&nbsp;</td>
    ...
    <tr> 
      <td><b><font size="2" color="#000080">合作伙伴</font></b></td>
      <td> <font size="2"> <strong><%=rs.getString("ename")%></strong> </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="hzmod" id="hzmod">
          <%
		   String hzmod1=rs.getString("hzmod").trim();
          String[] hzmod=new String[]{"有","无"};
          for(int i=0;i<hzmod.length;i++)
           {
             if(hzmod1.equals(hzmod[i]))
               out.println("<option selected>"+hzmod[i]+"</option>");
             else
               out.println("<option >"+hzmod[i]+"</option>");
           }
        %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="hzdel" id="hzdel">
          <%
		   String hzdel1=rs.getString("hzdel").trim();
          String[] hzdel=new String[]{"有","无"};
          for(int i=0;i<hzdel.length;i++)
           {
             if(hzdel1.equals(hzdel[i]))
               out.println("<option selected>"+hzdel[i]+"</option>");
             else
               out.println("<option >"+hzdel[i]+"</option>");
           }
		      %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="hzview" id="hzview">
          <%
		   String hzview1=rs.getString("hzview").trim();
          String[] hzview=new String[]{"有","无"};
          for(int i=0;i<hzview.length;i++)
           {
             if(hzview1.equals(hzview[i]))
               out.println("<option selected>"+hzview[i]+"</option>");
             else
               out.println("<option >"+hzview[i]+"</option>");
           }
		      %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="hzzt" id="hzzt">
          <%
		   String hzzt1=rs.getString("hzzt").trim();
          String[] hzzt=new String[]{"有","无"};
          for(int i=0;i<hzzt.length;i++)
           {
             if(hzzt1.equals(hzzt[i]))
               out.println("<option selected>"+hzzt[i]+"</option>");
             else
               out.println("<option >"+hzzt[i]+"</option>");
           }
		      %>
        </select>
        </font>&nbsp;</td>
    ...
    <tr> 
      <td><strong><font color="#000080" size="2">工资管理</font></strong></td>
      <td> <font size="2"> 
        <select name="wageadd" id="wageadd">
          <%String wageadd1=rs.getString("wageadd").trim();
          String[] wageadd=new String[]{"有","无"};
          for(int i=0;i<wageadd.length;i++)
           {
             if(wageadd1.equals(wageadd[i]))
               out.println("<option selected>"+wageadd[i]+"</option>");
             else
               out.println("<option >"+wageadd[i]+"</option>");
           }
        %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="wagemod" id="wagemod">
          <%String wagemod1=rs.getString("wagemod").trim();
          String[] wagemod=new String[]{"有","无"};
          for(int i=0;i<wagemod.length;i++)
           {
             if(wagemod1.equals(wagemod[i]))
               out.println("<option selected>"+wagemod[i]+"</option>");
             else
               out.println("<option >"+wagemod[i]+"</option>");
           }
        %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="wagedel" id="wagedel">
          <%String wagedel1=rs.getString("wagedel").trim();
          String[] wagedel=new String[]{"有","无"};
          for(int i=0;i<wagedel.length;i++)
           {
             if(wagedel1.equals(wagedel[i]))
               out.println("<option selected>"+wagedel[i]+"</option>");
             else
               out.println("<option >"+wagedel[i]+"</option>");
           }
        %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="wageview" id="wageview">
          <%String wageview1=rs.getString("wageview").trim();
          String[] wageview=new String[]{"有","无"};
          for(int i=0;i<wageview.length;i++)
           {
             if(wageview1.equals(wageview[i]))
               out.println("<option selected>"+wageview[i]+"</option>");
             else
               out.println("<option >"+wageview[i]+"</option>");
           }
        %>
        </select>
        </font>&nbsp;</td>
      <td> <font size="2"> 
        <select name="wagezt" id="wagezt">
          <%String wagezt1=rs.getString("wagezt").trim();
          String[] wagezt=new String[]{"有","无"};
          for(int i=0;i<wagezt.length;i++)
           {
             if(wagezt1.equals(wagezt[i]))
               out.println("<option selected>"+wagezt[i]+"</option>");
             else
               out.println("<option >"+wagezt[i]+"</option>");
           }
        %>
        </select>
        </font>&nbsp;</td>
