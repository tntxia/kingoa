...
request.setCharacterEncoding("gb2312");
 ...
 String strSQL="insert into ht_mb(q_name,q_topic,q_company,q_addr,q_man,q_tel,q_fax,q_email,q_net,q_post,q_number,q_tk,remark,q_date) values('" + q_name + "','" + q_topic + "','" + q_company +"','"+q_addr+"','"+q_man+"','"+q_tel+"','"+q_fax+"','"+q_email+"','"+q_net+"','"+q_post+"','"+q_number+"','"+q_tk+"','"+remark1+"','"+q_date+"')";
