...
String hiddens=request.getParameter("hiddens");
 ...
 String remark=request.getParameter("remark");
  ...
  String strSQL="update bank set com_bank='" + com_bank + "',bank='" + bank + "',bank_num='" + bank_num + "',bank_je='" + bank_je + "',bank_hb='" + bank_hb + "',dept='" + dept + "',deptjb='" + deptjb + "',remark='" + remark +"',hiddens='"+hiddens+ "' where id='" + id1 + "'";
...
<div align="center"><br><br><br> <p><img src="../../images/cg.jpg" width="111" height="111"></p><hr style="BORDER-BOTTOM-STYLE: dotted; BORDER-LEFT-STYLE: dotted; BORDER-RIGHT-STYLE: dotted; BORDER-TOP-STYLE: dotted" color=#a9a9a9 size=1><p><font color="#ff0000" size="3">修改成功!</font></b></p>
  <p><font color="#000000"></font><a style="font-size: 12px" href="hlxx.jsp">返回</a></p>
</div>
</body>
</html>