...
%>
<body bgcolor="#ffffff" text="#000000" topmargin="0" bgcolor="#EBEBEB">
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <tr bgcolor="#FFFFFF">
      ...
      <td width="11%"><font size="2">隐藏该项目:</font>&nbsp;</td>
	  ...
	  <%   
String hiddenss=(String) rs.getString("hiddens");
%>
...
<input type="checkbox" name="hiddens" checked="checked" />
