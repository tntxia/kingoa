...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr height="8" bgcolor="#d3d8eb"> <td width="18" height="8" nowrap><span class="STYLE1"><FONT SIZE="2">#</FONT></span></td>
<td width="145" height="8" nowrap> 
<div align="center" class="STYLE1">
  <div align="center"><FONT SIZE="2">开户名称</font>&nbsp;</div>
</div></td><td width="173" height="8" nowrap> 
<div align="center" class="STYLE1">
  <div align="center"><FONT SIZE="2">开户银行</font>&nbsp;</div>
</div></td><td width="122" height="8" nowrap> 
<div align="center" class="STYLE1">
  <div align="center"><FONT SIZE="2">银行帐号</font>&nbsp;</div>
</div></td><td width="92" height="8" nowrap><div align="left"><span class="STYLE1"><FONT SIZE="2">上期余额</FONT></span></div></td>
<td width="108" height="8" nowrap><span class="STYLE1"><FONT SIZE="2">本期借方金额</FONT></span></td>
<td width="104" height="8" nowrap><span class="STYLE1"><FONT SIZE="2">本期贷方金额</FONT></span></td>
<TD WIDTH="96" HEIGHT="8" nowrap> 
<DIV ALIGN="center" class="STYLE1"><FONT SIZE="2">本期余额</font>&nbsp;</div></TD><td width="105" height="8" nowrap> 
<div align="center" class="STYLE1"><FONT SIZE="2">折本币金额</font>&nbsp;</div></td>
</tr> 
<%i = 0;
   while(i<intPageSize && sqlRst.next()){ int id=sqlRst.getInt(1);%> <tr bgcolor="#EFEFEF" style="cursor:hand;" onClick="window.open('sview-hl.jsp?id=<%=id%>&sdate=<%=sdate%>&edate=<%=edate%>','rtop', 'height=432, width=955, top=50, left=50, toolbar=yes, menubar=no, scrollbars=yes, resizable=no,location=no, status=no')" onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" height="8"> 
...
double zje=0.00;
String strSQLpay="select l_sqje from credit_debit where g_bank='"+bank_name1+"' and g_banknum='"+bank_num1+"'  and  l_c_d='贷方'  and  l_date<'"+sdate+"'";
...
double zje1=0.00;
String strSQLpay1="select l_sqje from credit_debit where g_bank='"+bank_name1+"' and g_banknum='"+bank_num1+"'  and  l_c_d='贷方'   and  l_date>='"+sdate+"'  and  l_date<='"+edate+"'";
...
double zjeg=0.00;
String strSQLg="select l_sqje from credit_debit where g_bank='"+bank_name1+"' and g_banknum='"+bank_num1+"' and  l_c_d='借方'   and  l_date<='"+sdate+"'";
...
double zjeg1=0.00;
String strSQLg1="select l_sqje from credit_debit where g_bank='"+bank_name1+"' and g_banknum='"+bank_num1+"'  and  l_c_d='借方'  and  l_date>='"+sdate+"'  and  l_date<='"+edate+"'";
