...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"> 
<TR BGCOLOR="#d3d8eb"> <td width="16%" HEIGHT="26"><FONT SIZE="2" COLOR="#000000">新品换货审批流程</font>&nbsp;</td><td colspan="3" HEIGHT="26"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td>&nbsp;</td><td COLSPAN="3"><font size="2"> 
</font><FONT SIZE="2" COLOR="#000000">技术部审批人:</FONT><font size="2"> <select size="1" name="dd_man"> 
<%
  try
  {
...
<td>&nbsp;</td><td COLSPAN="3"><FONT SIZE="2" COLOR="#000000">销售部审批人:</FONT><font size="2"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td height="23">&nbsp;</td><td COLSPAN="3"><FONT SIZE="2" COLOR="#000000">主管审批人:</FONT><font size="2"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td>&nbsp;</td><td COLSPAN="3"><FONT SIZE="2" COLOR="#000000">OP操作人:</FONT><font size="2"> 
<select name="fourspman" size="1" id="select"> <%
  try
  {
    ResultSet rs=infocrmdb.executeQuery("select name from username");
    while(rs.next())
