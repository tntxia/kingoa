...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> 
      <td height="6" colspan="6"><FONT COLOR="#000000" SIZE="2">合同审批管理 &gt;&gt; 
        </font>&nbsp;</td>
    ...
    <tr height="8" bgcolor="#d3d8eb"><td width="135" height="8">
<div align="left"><font color="#000000"><font size="2">申请部门</font></font>&nbsp;</div>
      </td>
      <td width="73" height="8">
<div align="left"><font color="#000000"><font size="2">职位</font></font>&nbsp;</div>      </td>
      <td width="134" height="8"><font color="#000000"><FONT SIZE="2">最低金额</FONT></font>&nbsp;</td>
      <td width="147" height="8"><font color="#000000"><FONT SIZE="2">最高金额</FONT></font>&nbsp;</td>
      <td width="111" height="8">
<div align="left"><font color="#000000"><font size="2">是否审批</font></font>&nbsp;</div>      </td>
      <td width="86" height="8">
<div align="left"><font color="#000000"><font size="2">审批人</font></font>&nbsp;</div>      </td>
      <td width="87" height="8">
<div align="left"><font color="#000000"><font size="2">是否复审</font></font>&nbsp;</div>      </td>
      <td width="81" height="8">
<div align="left"><font color="#000000"><font size="2">复审人</font></font>&nbsp;</div>      </td>
...
<div align="left"><font color="#000000"><font size="2">操作</font></font>&nbsp;</div>      </td>
   ...
   while(i<intPageSize && sqlRst.next()){ int id=sqlRst.getInt(1);%>
    <tr height="8"onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      <td width="135" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div>      </td>
      <td width="73" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div>      </td>
      <td width="134" height="6"><FONT SIZE="2"><%=sqlRst.getString(4)%></font>&nbsp;</td>
      <td width="147" height="6"><FONT SIZE="2"><%=sqlRst.getString(5)%></font>&nbsp;</td>
      <td width="111" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div>      </td>
      <td width="86" height="6"> 
        <div align="left"><FONT SIZE="2"><%=sqlRst.getString(7)%></font>&nbsp;</div>      </td>
      <td width="87" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(8)%></font>&nbsp;</div>      </td>
      <td width="81" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(9)%></font>&nbsp;</div>      </td>
    ...
    <% i++; } %>
    <tr> 
      <td colspan=13 align=center height="22"> 
