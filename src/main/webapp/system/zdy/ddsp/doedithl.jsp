...
<%
 ...
 String if_sp=request.getParameter("if_sp");
  String fspman=request.getParameter("fspman");
  String remark=request.getParameter("remark");
  String strSQL="update ddsp set price_min='" + price_min + "',price_max='" + price_max + "',dept='" + dept + "',role='" + role + "',if_sp='" + if_sp + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',remark='" + remark + "' where id='" + id1 + "'";
