...
strSQL = "select count(*) from sam_sp";
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> <td height="6" colspan="5"><font color="#000000" size="2">样品审批管理 &gt;&gt; 
</font>&nbsp;</td><td colspan="3" height="6"> <div align="right"><font color="#000000" size="2"> 
...
</font>&nbsp;</div></td></tr> <tr height="8" bgcolor="#d3d8eb"> <td width="143" height="8"> 
<div align="left"><font color="#000000"><font size="2">样品申请部门</font></font>&nbsp;</div></td><td width="113" height="8"> 
<div align="left"><font color="#000000"><font size="2">职位</font></font>&nbsp;</div></td><TD WIDTH="121" HEIGHT="8"> 
<DIV ALIGN="left"><font color="#000000"><FONT SIZE="2">最少金额</FONT></font>&nbsp;</div></TD><TD WIDTH="125" HEIGHT="8"> 
<DIV ALIGN="left"><font color="#000000"><FONT SIZE="2">最多金额</FONT></font>&nbsp;</div></TD><td width="119" height="8"> 
<div align="left"><font color="#000000"><font size="2">审批人</font></font>&nbsp;</div></td><td width="144" height="8"> 
<div align="left"><font color="#000000"><font size="2">是否复审</font></font>&nbsp;</div></td><td width="93" height="8"> 
<div align="left"><font color="#000000"><font size="2">复审人</font></font>&nbsp;</div></td><td width="143" height="8"> 
...
<td width="143" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div></td><td width="113" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div></td><TD WIDTH="121" HEIGHT="6"> 
<DIV ALIGN="left"><FONT SIZE="2"><%=sqlRst.getString(4)%></font>&nbsp;</div></TD><TD WIDTH="125" HEIGHT="6"> 
<DIV ALIGN="left"><FONT SIZE="2"><%=sqlRst.getString(5)%></font>&nbsp;</div></TD><td width="119" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div></td><td width="144" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(7)%></font>&nbsp;</div></td><td width="93" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(8)%></font>&nbsp;</div></td><td width="143" height="6"> 
