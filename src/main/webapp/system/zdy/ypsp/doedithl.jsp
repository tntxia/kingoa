...
<%
 ...
 String fif=request.getParameter("fif");
  ...
  String strSQL="update sam_sp set   price_min='" + price_min + "',price_max='" + price_max + "',dept='" + dept + "',role='" + role + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',remark='" + remark + "' where id='" + id1 + "'";
