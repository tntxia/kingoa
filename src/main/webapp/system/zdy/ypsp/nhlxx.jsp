...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"> 
<TR BGCOLOR="#d3d8eb"> <td width="16%"><font size="2" color="#000000">增加审批流程</font>&nbsp;</td><td colspan="3"> 
...
</div></td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><font size="2" color="#000000">样品申请部门:</font>&nbsp;</td><td width="24%"><font size="2" face="Arial, Helvetica, sans-serif"> 
...
%> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">样品申请人职位:</font>&nbsp;</td><td width="41%"> 
...
<option>是</option> <option>否</option> </select> 　　　复审者:</font><font size="2"> 
