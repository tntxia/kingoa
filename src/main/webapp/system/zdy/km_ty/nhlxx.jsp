...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <tr> 
      <td width="15%" bgcolor="#d3d8eb"><font size="2" color="#000000">新增</font>&nbsp;</td>
      <td width="85%" bgcolor="#d3d8eb"> <div align="right"><font size="2" color="#000000"> 
    ...
    <tr> 
      <td width="15%" bgcolor="#e8ebf5"><font size="2">知识库类型:</font>&nbsp;</td>
      <td width="85%"><font size="2" color="#000000"> 
        <input type="text" name="xyjb_name" size="60">
        </font>&nbsp;</td>
    </tr>
    <tr> 
      <td width="15%" bgcolor="#e8ebf5"><font size="2">备　　注:</font>&nbsp;</td>
      <td width="85%"><font size="2" color="#000000"> 
        <textarea name="remark" cols="60"></textarea>
        </font>&nbsp;</td>
    </tr>
    <tr> 
      <td width="15%" bgcolor="#e8ebf5"><font size="2">创建日期:</font>&nbsp;</td>
      <td width="85%"> <div align="left"><font size="2" color="#000000"> </font> 
