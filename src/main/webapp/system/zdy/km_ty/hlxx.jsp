...
strSQL = "select count(*) from km_ty";
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <tr> 
      <td height="6" width="403"><font size="2" color="#000000">知识库类型自定义</font>&nbsp;</td>
      <td colspan="2" height="6"> 
        <div align="right"><font color="#000000" size="2"> 
          <input type="button" value="添加" name="B22" style="background-color: #E1E1E1; font-family: 宋体; font-size: 9pt; border: 1 groove #C3D9FF" onClick="window.open('nhlxx.jsp','_self', 'height=200, width=550, top=200, left=200, toolbar=yes, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no')">
          </font>&nbsp;</div>
      </td>
    </tr>
    <tr height="8" bgcolor="#d3d8eb"> <td width="403" height="8"> 
        <div align="left"><font color="#000000"><font size="2">知识库类型名称</font></font>&nbsp;</div>
      </td>
      <td width="131" height="8"> 
        <div align="left"><font size="2">日期</font>&nbsp;</div>
      </td>
      <td width="228" height="8"> 
   ...
   while(i<intPageSize && sqlRst.next()){ %>
    <tr height="8"onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      ...
      <td width="403" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div>
      </td>
      <td width="131" height="6"><font size="2"><%=sqlRst.getDate(4)%></font>&nbsp;</td>
      <td width="228" height="6"> 
        <div align="center"><font color="#000000" size="2"> 
          <input type="button" value="编辑" name="B222" style="background-color: #E1E1E1; font-family: 宋体; font-size: 9pt; border: 1 groove #C3D9FF" onClick="window.open('edit-hl.jsp?id=<%=id%>','_self', 'height=200, width=550, top=200, left=200, toolbar=yes, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no')">
