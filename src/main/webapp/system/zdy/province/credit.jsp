...
strSQL = "select id,province_num,province_name from province order by province_num asc";
sqlRst = einfodb.executeQuery(strSQL);
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
  <tr bgcolor="#FFFFFF"> 
    <td height="30" colspan="2" bgcolor="#d3d8eb"><font size="2" color="#000000">省市列表</font><font color="#000000" size="2"> &gt;&gt;</font> 
    <div align="left"></div></td>
    <td width="303" height="30" bgcolor="#d3d8eb"> <div align="right"> 
  ...
  <tr height="8"> 
    <td width="93"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</td>
    <td height="8" width="309"><font size="2"><%String p=sqlRst.getString(3);%><%=p%></font>&nbsp;</td>
    <td width="303" height="8"> <div align="center"><a href="editncredit.jsp?id=<%=id%>" style="font-size: 12px"><font size="2">编辑</font></a> 
        <font size="2"><a href="del-credit.jsp?id=<%=id%>&p=<%=p%>" style="font-size: 12px">删除</a> 
        <a href="../city/credit.jsp?p=<%=p%>" style="font-size: 12px">所属城市</a> </font>&nbsp;</div></td>
  </tr>
  <% i++; } %>
  <tr> 
    <td colspan=4 align=center height="16"> <div align="right"><font color="#000000" size="2"> 
