...
String sql="select  * from documentsp where id='"+id2+"'";
...
<td width="16%"><FONT SIZE="2" COLOR="#000000">内部签呈申请部门:</font>&nbsp;</td>
...
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td>
<td width="19%"><font size="2" color="#000000">内部签呈申请人职位:</font>&nbsp;</td>
<td width="41%"> 
<font color="#000000" size="2"> <select name="role" size="1" id="role"> <%
        ...
        %> </select> </font>&nbsp;</td>
</tr> <tr bgcolor="#FFFFFF"> <td><font color="#000000">&nbsp;</font>&nbsp;</td>
...
<select size="1" name="dd_man"> <%
        ...
        %> </select> </font>&nbsp;</td>
</tr> <tr bgcolor="#FFFFFF"> <td><font size="2" color="#000000">是否需要二审:</font>&nbsp;</td><td><font size="2" color="#000000">
...
<select size="1" name="fspman"> <%
        ...
        %> </select> </font>&nbsp;</td>
</tr> <tr bgcolor="#FFFFFF"> <td width="16%"><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td><td><font size="2" color="#000000">
