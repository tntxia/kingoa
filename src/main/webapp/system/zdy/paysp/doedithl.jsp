...
<%
 ...
 String fourspif=request.getParameter("fourspif");
  String fourspman=request.getParameter("fourspman");
  String remark=request.getParameter("remark");
  String strSQL="update paysp set dept='" + dept + "',role='" + role + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',firspif='" + firspif + "',firspman='" + firspman + "',fourspif='" + fourspif + "',fourspman='" + fourspman + "',remark='" + remark + "' where id='" + id1 + "'";
