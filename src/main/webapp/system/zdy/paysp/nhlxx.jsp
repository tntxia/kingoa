...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <TR BGCOLOR="#d3d8eb"> 
      <td width="16%"><font size="2" color="#000000">付款审批流程</font>&nbsp;</td>
...
%>
      ...
      <td width="13%" bgcolor="#e8ebf5"><font size="2" color="#000000">付款申请人职位:</font>&nbsp;</td>
      <td width="56%"> <font color="#000000" size="2"> 
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td height="23" bgcolor="#e8ebf5"><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td>
      <td><font size="2" color="#000000">
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td bgcolor="#e8ebf5"><font size="2" color="#000000">是否需要四审:</font>&nbsp;</td>
      <td><font size="2" color="#000000">
          <select name="fourspif" id="select2">
          <option>是</option>
          <option>否</option>
        </select>
        　　</font>&nbsp;</td>
      <td colspan="2"><font size="2" color="#000000">第四审批人: 
