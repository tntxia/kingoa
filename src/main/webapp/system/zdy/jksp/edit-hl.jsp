...
String sql="select  * from jksp where id='"+id2+"'";
...
<td width="16%"><font size="2" color="#000000">借款申请部门:</font>&nbsp;</td>
...
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">借款人职位:</font>&nbsp;</td><td width="41%"> 
...
<select size="1" name="dd_man"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td><font size="2" color="#000000">是否需要二审:</font>&nbsp;</td><td><font size="2" color="#000000">
...
<select size="1" name="fspman"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td><td><font size="2" color="#000000">
...
<select name="firspman" size="1" id="firspman"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
<td colspan="3"> 
