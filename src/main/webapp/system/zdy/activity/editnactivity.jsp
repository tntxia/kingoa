...
String sql="select * from activity_type where id='"+id1+"'";
...
<form name="form1" method="post" action="doeditactivity.jsp">
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <TR BGCOLOR="#d3d8eb">
      <td width="20%" height="14"><font size="2" color="#000000">编辑 &gt;&gt;</font>&nbsp;</td>
    ...
    <TR BGCOLOR="#d3d8eb"> 
      <td width="20%" bgcolor="#e8ebf5"><font size="2" color="#000000">活动类型:</font>&nbsp;</td>
      <td colspan="2" bgcolor="#FFFFFF"> 
        <div align="left"><font size="2" color="#000000"> 
          <input type="text" name="act_name" size="20" maxlength="30" value="<%=rs.getString("act_name")%>">
          </font>&nbsp;</div>
      </td>
    </tr>
  </table>
