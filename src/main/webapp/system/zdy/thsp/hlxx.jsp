...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> 
      <td height="6" colspan="3"><font color="#000000" size="2">退货审批流程 &gt;&gt; 
        </font>&nbsp;</td>
   ...
   while(i<intPageSize && sqlRst.next()){ int id=sqlRst.getInt(1);%>
    <tr height="8"onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      <td width="124" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div></td>
      <td width="132" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div></td>
      <td width="105" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(4)%></font>&nbsp;</div></td>
      <td width="111" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div></td>
