...
String sql="select  * from xzsp where id='"+id2+"'";
...
<form name="form1" method="post" action="doedithl.jsp">   <table height=8 width="100%" 
...
<td width="16%"><FONT SIZE="2" COLOR="#000000">薪资异动申请部门:</font>&nbsp;</td><td width="24%"><font size="2" face="Arial, Helvetica, sans-serif"> 
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">薪资异动申请人职位:</font>&nbsp;</td><td width="41%"> 
<font size="2"> <select name="role" size="1" id="role"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td>&nbsp;</td><td>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第一审批人:</font><font size="2"> 
<select size="1" name="dd_man"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td>&nbsp;</td><td><font size="2" color="#000000">是否需要二审: 
<select name="fif"> <% String fif1=rs.getString("fif").trim();
        ...
        %> </select> </font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第二审批人:</font><font size="2"> 
<select size="1" name="fspman"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="16%">&nbsp;</td><td><font size="2" color="#000000">是否需要三审: 
<select name="firspif" id="firspif"> <% String firspif1=rs.getString("firspif").trim();
        ...
        %> </select> </font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第三审批人:</font><font size="2"> 
<select name="firspman" size="1" id="firspman"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><font size="2" color="#000000">备　　注:</font>&nbsp;</td><td colspan="3"> 
