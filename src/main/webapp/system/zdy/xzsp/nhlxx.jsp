...
<form name="form1" method="post" action="do_hlxx.jsp"> <table height=8 width="100%" 
bordercolor="#CCBE5A" cellspacing="0" 
                        bordercolordark="#ffffff" cellpadding="3" 
                        align="center" bgcolor="#ffffff" bordercolorlight="#7f9db9" 
                        border="1"> 
<TR BGCOLOR="#d3d8eb"> <td width="16%"><FONT SIZE="2" COLOR="#000000">薪资异动审批流程</font>&nbsp;</td><td colspan="3"> 
...
</div></td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><FONT SIZE="2" COLOR="#000000">申请部门:</font>&nbsp;</td><td width="24%"><font size="2" face="Arial, Helvetica, sans-serif"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td>&nbsp;</td><td><font size="2">&nbsp; 
</font><font size="2" color="#000000">　　</font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第一审批人:</font><font size="2"> 
...
%> </select> </font><font size="2" color="#000000">&nbsp;</font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> 
<td>&nbsp;</td><td><font size="2" color="#000000">是否需要二审: <select name="fif"> <option>是</option> 
<option>否</option> </select> 　　</font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第二审批人:</font><font size="2"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td>&nbsp;</td><td><font size="2" color="#000000">是否需要三审: 
<select name="firspif" id="select2"> <option>是</option> <option>否</option> </select> 
　　</font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第三审批人:</font><font size="2"> 
...
<td width="16%"><font size="2" color="#000000">添加日期:</font>&nbsp;</td><td colspan="3"> 
<div align="left"><font size="2" color="#000000"> </font> <input type="hidden" name="dd_date" value="<%=currentDate%>"> 
<%=currentDate%> </div></td></tr> </table></form>
</body><%}}%>
</html>
