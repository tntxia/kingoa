...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <tr> 
      <td width="13%" bgcolor="#d3d8eb"><font size="2" color="#000000">付款方式</font>&nbsp;</td>
    ...
    <tr> 
      <td width="13%" bgcolor="#e8ebf5"><font size="2" color="#000000">付款方式:</font>&nbsp;</td>
      <td width="87%"><font size="2" color="#000000"> 
        <input type="text" name="payment" size="60">
        </font>&nbsp;</td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td width="87%"> 
        <div align="left"><font size="2" color="#000000"> </font> 
          <input type="hidden" name="pay_date" value="<%=currentDate%>"><%=currentDate%>        </div>      </td>
    </tr>
  </table>
</form>
</body><%}}%>
