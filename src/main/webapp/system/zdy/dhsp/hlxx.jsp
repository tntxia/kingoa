...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> 
      <td height="6" colspan="3"><font color="#000000" size="2">调货审批管理 &gt;&gt; 
        </font>&nbsp;</td>
    ...
    <tr height="8" bgcolor="#d3d8eb"> <td width="126" height="8"> 
        <div align="left"><font color="#000000"><font size="2">申请部门</font></font>&nbsp;</div>
      </td>
      <td width="151" height="8"> 
        <div align="left"><font color="#000000"><font size="2">申请人职位</font></font>&nbsp;</div>
      </td>
      <td width="90" height="8"> 
        <div align="left"><font color="#000000"><font size="2">审批人</font></font>&nbsp;</div>
      </td>
      <td width="127" height="8"> 
        <div align="left"><font color="#000000"><font size="2">是否需要复审</font></font>&nbsp;</div>
      </td>
      <td width="82" height="8"> 
        <div align="left"><font color="#000000"><font size="2">复审人</font></font>&nbsp;</div>
      </td>
      <td width="98" height="8"> <font size="2" color="#000000">添加</font><font size="2" color="#000000">日期</font>&nbsp;</td>
   ...
   while(i<intPageSize && sqlRst.next()){ int id=sqlRst.getInt(1);%>
    <tr height="8"onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      ...
      <td width="151" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div>
      </td>
      <td width="90" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(4)%></font>&nbsp;</div>
      </td>
      <td width="127" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(5)%></font>&nbsp;</div>
      </td>
      <td width="82" height="6"> 
        <div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div>
      </td>
      <td width="98" height="6"><font size="2"><%=sqlRst.getDate(8)%></font>&nbsp;</td>
    ...
    <% i++; } %>
    <tr> 
      <td colspan=11 align=center height="22"> 
