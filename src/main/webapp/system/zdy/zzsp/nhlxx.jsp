...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"> 
<TR BGCOLOR="#d3d8eb"> <td width="16%"><FONT SIZE="2" COLOR="#000000">转正审批流程</font>&nbsp;</td><td colspan="3"> 
...
</div></td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><FONT SIZE="2" COLOR="#000000">转正申请部门:</font>&nbsp;</td>
...
%> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">转正申请人职位:</font>&nbsp;</td><td width="41%"> 
...
<td><font size="2">&nbsp; 
</font><font size="2" color="#000000">　　</font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第一审批人: 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> 
<td><font size="2" color="#000000">是否需要二审:</font>&nbsp;</td><td><font size="2" color="#000000">
    <select name="fif"> <option>是</option> 
<option>否</option> </select> 　　</font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第二审批人: 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td><td><font size="2" color="#000000">
<select name="firspif" id="select2"> <option>是</option> <option>否</option> </select> 
　　</font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第三审批人: 
...
<tr bgcolor="#FFFFFF"> 
    <td><font size="2" color="#000000">是否需要四审:</font>&nbsp;</td>
...
<tr bgcolor="#FFFFFF"> <td width="16%"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
<td colspan="3"> 
<textarea name="remark" cols="60"></textarea> </td></tr> <tr bgcolor="#FFFFFF"> 
<td width="16%"><font size="2" color="#000000">添加日期:</font>&nbsp;</td>
<td colspan="3"> 
