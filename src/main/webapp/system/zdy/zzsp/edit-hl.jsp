...
String sql="select  * from zzsp where id='"+id2+"'";
...
<td width="16%"><FONT SIZE="2" COLOR="#000000">转正申请部门:</font>&nbsp;</td>
...
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">转正请人职位:</font>&nbsp;</td><td width="41%"> 
<font color="#000000" size="2"> <select name="role" size="1" id="role"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td><font color="#000000">&nbsp;</font>&nbsp;</td>
