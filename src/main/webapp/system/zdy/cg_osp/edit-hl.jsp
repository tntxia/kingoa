...
String sql="select  * from cgo_sp where id='"+id2+"'";
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="11%"><font size="2" color="#000000">申请部门:</font>&nbsp;</td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="11%"><font size="2" color="#000000">审批额度:</font>&nbsp;</td>
      <td colspan="3"><font size="2" color="#000000">最少金额: 
        <input type="text" name="price_min" size="10" value="<%=rs.getString("price_min")%>">
        RMB, 最多金额: 
        <input type="text" name="price_max" size="10" value="<%=rs.getString("price_max")%>">
        RMB；</font>&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="11%"><font size="2" color="#000000">审批人:</font>&nbsp;</td>
      <td colspan="3"><font size="2"> 
        ...
        </font><font size="2" color="#000000">　　<font color="#000000">是否需要复审: 
        <select name="fif">
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="11%"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
      <td colspan="3"> 
