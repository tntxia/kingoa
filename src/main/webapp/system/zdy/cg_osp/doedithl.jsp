...
<%
 ...
 String fif=request.getParameter("fif");
  ...
  String strSQL="update cgo_sp set dept='" + dept + "',role='" + role + "',price_min='" + price_min + "',price_max='" + price_max + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',remark='" + remark + "' where id='" + id1 + "'";
