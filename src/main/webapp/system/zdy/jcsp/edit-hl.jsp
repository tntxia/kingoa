...
String sql="select  * from  jcsp where id='"+id2+"'";
...
<td width="16%"><font size="2" color="#000000">奖惩申请部门:</font>&nbsp;</td>
...
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">奖惩请人职位:</font>&nbsp;</td><td width="41%"> 
