...
String sql="select  * from spbmsp where id='"+id2+"'";
...
<td width="16%"><FONT SIZE="2" COLOR="#000000">商品编码申请部门:</font>&nbsp;</td><td width="24%"><font size="2" face="Arial, Helvetica, sans-serif"> 
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td><td width="19%"><font size="2" color="#000000">商品编码申请人职位:</font>&nbsp;</td><td width="41%"> 
