...
strSQL = "select count(*) from   spbmsp";
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> <td height="6" colspan="3"><FONT COLOR="#000000" SIZE="2">商品编码审批流程 &gt;&gt; 
...
</font>&nbsp;</div></td></tr> <tr height="8" bgcolor="#d3d8eb"> <td width="158" height="8"> 
<font color="#000000"><font size="2">申请部门</font></font>&nbsp;</td><td width="168" height="8"> 
<div align="left"><font color="#000000"><FONT SIZE="2">申请人职位</FONT></font>&nbsp;</div></td><td width="116" height="8"> 
<div align="left"><font color="#000000"><font size="2">第一审批人</font></font>&nbsp;</div></td><td width="139" height="8"> 
<div align="left"><font color="#000000"><font size="2">是否需要二审</font></font>&nbsp;</div></td><td width="141" height="8"> 
<div align="left"><font color="#000000"><font size="2">第二审批人</font></font>&nbsp;</div></td><td width="122" height="8"> 
<font size="2" color="#000000">添加</font><font size="2" color="#000000">日期</font>&nbsp;</td><td width="159" height="8"> 
...
<td width="158" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div></td><td width="168" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div></td><td width="116" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(4)%></font>&nbsp;</div></td><td width="139" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(5)%></font>&nbsp;</div></td><td width="141" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div></td><td width="122" height="6"><font size="2"><%=sqlRst.getDate("dd_date")%></font>&nbsp;</td><td width="159" height="6"> 
