...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"> 
<TR BGCOLOR="#d3d8eb"> <td width="18%"><font size="2" color="#000000">合同审批流程</font>&nbsp;</td><td colspan="3"> 
...
</div></td></tr> <tr bgcolor="#FFFFFF"> <td width="18%"><font size="2" color="#000000">申请部门:</font>&nbsp;</td>
...
%> </select> </font>&nbsp;</td><td width="15%"><font size="2" color="#000000">申请人职位:</font>&nbsp;</td><td width="26%"> 
...
RMB；</font>&nbsp;</td></TR> <tr bgcolor="#FFFFFF"> <td width="18%"><font size="2" color="#000000">是否需要审批:</font>&nbsp;</td>
<td><font size="2"> 
<select name="ifsp" id="ifsp"> <option>是</option> <option>否</option> </select> 
</font>&nbsp;</td><td><font size="2" color="#000000">审批人:</font>&nbsp;</td><td><font size="2"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="18%"><font size="2" color="#000000">是否需要复审:</font>&nbsp;</td>
<td><font size="2"> 
<select name="iffsp" id="ifsp"> <option>是</option> <option>否</option> </select> 
</font>&nbsp;</td><td><font size="2" color="#000000">复审人:</font>&nbsp;</td><td><font size="2"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="18%"><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td>
<td><font size="2"> 
<select name="firsp" id="ifsp"> <option>是</option> <option>否</option> </select> 
</font>&nbsp;</td><td><font size="2" color="#000000">审批人:</font>&nbsp;</td><td><font size="2"> 
...
%> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="18%"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
<td colspan="3"> 
