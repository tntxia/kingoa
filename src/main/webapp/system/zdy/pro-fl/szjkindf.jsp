  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr height="8"> 
      ...
      <td width="100%" height="2"> 
        <p><b>＊　</b><font size="2" face="Arial, Helvetica, sans-serif"><a href="sseckind.jsp?proname=<%=proname%>&firstkind=<%=id%>" target="main" style="font-size: 12px"><%=proname%></a> 
         </font></p>
      </td>
    </tr>
    <% i++; } %>
    <tr> 
      <td align=center height="22"> 
        <div align="right"><font color="#000000" size="2" face="Arial, Helvetica, sans-serif"> 
          ...
          <a href="szjkindf.jsp?page=<%=intPage+1%>" style="font-size: 12px">下一页</a> 
          <% 
}

%>
          <%if(intPage>1){%>
          <a href="szjkindf.jsp?page=<%=intPage-1%>" style="font-size: 12px">上一页</a> 
          <% 
}
