...
<form name="form1" method="post" action="w.jsp" onSubmit="return isValid();">
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <tr> 
      ...
      <td width="74%" bgcolor="#d3d8eb"> <div align="right"><font size="2" color="#000000" face="Arial, Helvetica, sans-serif"> 
          <% String getmessagefl = (String) session.getValue("profl_message");
         if(getmessagefl==null) getmessagefl="";
         %>
          <%= getmessagefl %> 
