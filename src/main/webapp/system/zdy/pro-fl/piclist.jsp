...
<%if(intPage<intPageCount){%> <a href="piclist.jsp?page=<%=intPage+1%>&id=<%=id%>&proname=<%=proname1%>" style="font-size: 12px">下一页</a> 
<% } %> <%if(intPage>1){%> <a href="piclist.jsp?page=<%=intPage-1%>&id=<%=id%>&proname=<%=proname1%>" style="font-size: 12px">上一页</a> 
