...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> <td height="30" colspan="5"><font color="#000000" size="2">费用审批流程 &gt;&gt; 
</font>&nbsp;</td><td colspan="4" height="30"> <div align="right"><font color="#000000" size="2"> 
...
</font>&nbsp;</div></td></tr> <tr height="8" bgcolor="#d3d8eb"> <td width="138" height="8"> 
<font color="#000000" size="2">费用</font><font color="#000000"><font size="2">申请部门</font></font>&nbsp;</td>
<td width="78" height="8"> 
<div align="left"><font color="#000000"><font size="2">职位</font></font>&nbsp;</div></td><TD WIDTH="120" HEIGHT="8"> 
<DIV ALIGN="left"><font color="#000000"><FONT SIZE="2">最少金额</FONT></font>&nbsp;</div></TD><TD WIDTH="114" HEIGHT="8"> 
<DIV ALIGN="left"><font color="#000000"><FONT SIZE="2">最多金额</FONT></font>&nbsp;</div></TD><td width="111" height="8"> 
<div align="left"><font color="#000000"><font size="2">第一审批人</font></font>&nbsp;</div></td><td width="102" height="8"> 
<div align="left"><font color="#000000"><font size="2">是否二审</font></font>&nbsp;</div></td><td width="104" height="8"> 
<div align="left"><font color="#000000"><font size="2">第二审批人</font></font>&nbsp;</div></td><td width="111" height="8"> 
...
<td width="138" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div></td><td width="78" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div></td><TD WIDTH="120" HEIGHT="6"> 
<DIV ALIGN="left"><FONT SIZE="2"><%=sqlRst.getString(4)%></font>&nbsp;</div></TD><TD WIDTH="114" HEIGHT="6"> 
<DIV ALIGN="left"><FONT SIZE="2"><%=sqlRst.getString(5)%></font>&nbsp;</div></TD><td width="111" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div></td><td width="102" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(7)%></font>&nbsp;</div></td><td width="104" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(8)%></font>&nbsp;</div></td><td width="111" height="6"><font size="2"><%=sqlRst.getDate("dd_date")%></font>&nbsp;</td><td width="121" height="6"> 
