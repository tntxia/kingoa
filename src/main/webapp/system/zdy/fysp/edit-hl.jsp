...
String sql="select  * from fysp where id='"+id2+"'";
...
<td width="16%" bgcolor="#e8ebf5"><font size="2" color="#000000">费用申请部门:</font>&nbsp;</td>
...
<select size="1" name="dept"> <%
        ...
        %> </select> </font>&nbsp;</td><td width="19%" bgcolor="#e8ebf5"><font size="2" color="#000000">费用请人职位:</font>&nbsp;</td>
<td width="41%"> 
<font color="#000000" size="2"> <select name="role" size="1" id="role"> <%
        ...
        %> </select> </font>&nbsp;</td></tr><tr bgcolor="#FFFFFF"> <TD WIDTH="14%" bgcolor="#e8ebf5"><FONT SIZE="2" COLOR="#000000">审批额度:</font>&nbsp;</td>
...
RMB；</font>&nbsp;</td></TR> <tr bgcolor="#FFFFFF"> <td><font color="#000000">&nbsp;</font>&nbsp;</td>
<td>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第一审批人: 
<select size="1" name="dd_man"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td bgcolor="#e8ebf5"><font size="2" color="#000000">是否需要二审:</font>&nbsp;</td>
<td><font size="2" color="#000000">
<select name="fif"> <% String fif1=rs.getString("fif").trim();
        ...
        %> </select> </font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第二审批人: 
<select size="1" name="fspman"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="16%" bgcolor="#e8ebf5"><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td>
<td><font size="2" color="#000000">
<select name="firspif" id="firspif"> <% String firspif1=rs.getString("firspif").trim();
        ...
        %> </select> </font>&nbsp;</td><td colspan="2"><font size="2" color="#000000">第三审批人: 
<select name="firspman" size="1" id="firspman"> <%
        ...
        %> </select> </font>&nbsp;</td></tr> <tr bgcolor="#FFFFFF"> <td width="16%" bgcolor="#e8ebf5"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
<td colspan="3"> 
