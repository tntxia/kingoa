...
<%
 ...
 String firspif=request.getParameter("firspif");
  ...
  String strSQL="update fysp set  price_min='" + price_min + "',price_max='" + price_max + "',dept='" + dept + "',role='" + role + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',firspif='" + firspif + "',firspman='" + firspman + "',remark='" + remark + "' where id='" + id1 + "'";
