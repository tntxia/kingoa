...
String sql="select  * from payment_fs where id='"+id2+"'";
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="20%" bgcolor="#e8ebf5"><font size="2" color="#000000">付款方式:</font>&nbsp;</td>
      <td width="80%"><font size="2" color="#000000"> 
        <input type="text" name="payment" value="<%=rs.getString(2)%>" size="60">
        </font>&nbsp;</td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="20%" bgcolor="#e8ebf5"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
      <td width="80%"><font size="2" color="#000000"> 
