...
String sql="select * from companytype where id='"+id1+"'";
...
<form name="form1" method="post" action="doeditzzxs.jsp">
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <TR BGCOLOR="#d3d8eb"> 
      <td width="20%"><font size="2" color="#000000">公司类别自定义:</font>&nbsp;</td>
      <td colspan="2"> 
        <div align="left"><font size="2" color="#000000"> 
          <input type="text" name="com_name" size="20" maxlength="30" value="<%=rs.getString("com_name")%>">
          </font>&nbsp;</div>
      </td>
    </tr>
  </table>
