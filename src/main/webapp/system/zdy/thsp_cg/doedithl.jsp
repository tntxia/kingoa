...
<%
 ...
 String firspif=request.getParameter("firspif");
  ...
  String strSQL="update thsp_supplier set dept='" + dept + "',role='" + role + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',firspif='" + firspif + "',firspman='" + firspman + "',remark='" + remark + "',price_min="+price_min+",price_max="+price_max+" where id='" + id1 + "'";
