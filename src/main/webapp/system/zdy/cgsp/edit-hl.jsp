...
String sql="select  * from cgsp where id='"+id2+"'";
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="11%" nowrap bgcolor="#e8ebf5"><font size="2" color="#000000">申请部门:</font>&nbsp;</td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="11%" nowrap bgcolor="#e8ebf5"><font size="2" color="#000000">审批人:</font>&nbsp;</td>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="11%" nowrap bgcolor="#e8ebf5"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
      <td colspan="3"> 
