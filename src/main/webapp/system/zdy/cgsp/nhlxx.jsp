...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <TR BGCOLOR="#d3d8eb"> 
      <td width="14%"><font size="2" color="#000000">采购审批流程</font>&nbsp;</td>
      <td colspan="3"> 
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="14%" bgcolor="#e8ebf5"><font size="2" color="#000000">申请部门:</font>&nbsp;</td>
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="14%" bgcolor="#e8ebf5"><font size="2" color="#000000">审批人:</font>&nbsp;</td>
...
%>
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="14%" bgcolor="#e8ebf5"><font size="2" color="#000000">备　　注:</font>&nbsp;</td>
      <td colspan="3"> 
        <textarea name="remark" cols="60"></textarea>      </td>
    </tr>
    <tr bgcolor="#FFFFFF"> 
      <td width="14%" bgcolor="#e8ebf5"><font size="2" color="#000000">添加日期:</font>&nbsp;</td>
      <td colspan="3"> 
