...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <tr> 
      <td height="6" colspan="5"><font color="#000000" size="2">采购审批管理 &gt;&gt; 
        </font>&nbsp;</td>
    ...
    <tr height="8" bgcolor="#d3d8eb"> 
      ...
      <td width="132" height="8"> 
        <div align="left"><font color="#000000"><font size="2">申请人职位</font></font>&nbsp;</div>      </td>
      ...
      <td width="90" height="8" bgcolor="#d3d8eb"> 
        <div align="left"><font color="#000000"><font size="2">审批人</font></font>&nbsp;</div>      </td>
      <td width="128" height="8" bgcolor="#d3d8eb"> 
        <div align="left"><font color="#000000"><font size="2">是否需复审</font></font>&nbsp;</div>      </td>
      <td width="82" height="8" bgcolor="#d3d8eb"> 
        <div align="left"><font color="#000000"><font size="2">复审人</font></font>&nbsp;</div>      </td>
      <td width="98" height="8" bgcolor="#d3d8eb"> <span class="STYLE1"><font size="2">添加日期</font>&nbsp;</span></td>
      <td width="126" height="8" bgcolor="#d3d8eb"> 
   ...
   while(i<intPageSize && sqlRst.next()){ int id=sqlRst.getInt(1);%>
    <tr height="8"onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      ...
      <td width="110" height="6"><font size="2"><%=sqlRst.getDouble("price_min")%></font>&nbsp;</td>
      <td width="90" height="6"><font size="2"><%=sqlRst.getDouble("price_max")%></font>&nbsp;</td>
      ...
      <td width="98" height="6"><font size="2"><%=sqlRst.getDate(10)%></font>&nbsp;</td>
