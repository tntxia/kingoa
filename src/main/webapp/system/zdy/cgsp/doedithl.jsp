...
request.setCharacterEncoding("gb2312");
 ...
 String fif=request.getParameter("fif");
  ...
  String strSQL="update cgsp set  dept='" + dept + "',role='" + role + "',price_min='" + price_min + "',price_max='" + price_max + "',dd_man='" + dd_man + "',fif='" + fif + "',fspman='" + fspman + "',remark='" + remark + "' where id='" + id1 + "'";
