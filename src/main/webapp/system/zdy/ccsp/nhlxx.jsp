...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"> 
<TR BGCOLOR="#d3d8eb"> <td width="16%"><FONT SIZE="2" COLOR="#000000">出差审批流程</font>&nbsp;</td><td colspan="3"> 
...
</div></td></tr> <tr bgcolor="#FFFFFF"> <td width="16%"><FONT SIZE="2" COLOR="#000000">出差申请部门:</font>&nbsp;</td>
...
%> </select> </font>&nbsp;</td>
<td width="19%"><font size="2" color="#000000">出差申请人职位:</font>&nbsp;</td>
<td width="41%"> 
...
<option>否</option> </select> 　　</font>&nbsp;</td>
...
%> </select> </font>&nbsp;</td>
</tr> <tr bgcolor="#FFFFFF"> <td><font size="2" color="#000000">是否需要三审:</font>&nbsp;</td><td><font size="2" color="#000000">
