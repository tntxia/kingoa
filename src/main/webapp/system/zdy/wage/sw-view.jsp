...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> 
      <td width="24%" height="2"><div align="left"><font size="2" color="#000080">工 
          资 年 份</font></div></td>
      <td width="20%" height="2"><div align="left"><font size="2" color="#000000"><%=rs.getString(2)%></font><font color="#000000" size="2">年</font></div></td>
      <td width="17%" height="2"><div align="left"><font size="2" color="#000080">工资月份</font></div></td>
      <td width="29%" height="2"><div align="left"><font size="2" color="#000000"><%=rs.getString(3)%></font><font color="#000000" size="2"> 月</font></div></td>
    </tr>
    <tr> 
      <td width="24%"><div align="left"><font size="2" color="#000080">员 工 
          名 称</font></div></td>
      <td width="20%"><div align="left"><font size="2" color="#000000"><%=rs.getString(4)%></font></div></td>
      <td width="17%"><div align="left"><font size="2" color="#000080">基本工资</font></div></td>
      <td width="29%"><div align="left"><font size="2" color="#000000"><%=nf.format(rs.getDouble(5))%>RMB</font></div></td>
    </tr>
    <tr> 
      <td width="24%"><div align="left"><font size="2" color="#000080">住房、交通补贴</font></div></td>
      <td width="20%"><div align="left"><font size="2" color="#000000"><%=nf.format(rs.getDouble(6))%>RMB</font></div></td>
      <td width="17%"><div align="left"><font size="2" color="#000080">职位奖金</font></div></td>
      <td width="29%"><div align="left"><font size="2" color="#000000"><%=nf.format(rs.getDouble(7))%>RMB</font></div></td>
    </tr>
    <tr> 
      <td width="24%"><div align="left"><font size="2" color="#000080">全勤奖</font></div></td>
      <td width="20%"><div align="left"><font size="2" color="#000000"><%=rs.getString(8)%>RMB</font></div></td>
      <td><div align="left"><font size="2" color="#000080">扣除社保费</font></div></td>
      <td><div align="left"><font size="2" color="#000000"><%=nf.format(rs.getDouble("menber_sb"))%>RMB</font></div></td>
    </tr>
    <tr> 
      <td><div align="left"><font size="2" color="#000080">履行合同奖金</font></div></td>
      <td colspan="3"><div align="left"><font size="2" color="#000000"><%=nf.format(rs.getDouble("menber_ht"))%>RMB</font></div></td>
    </tr>
    <tr> 
      <td width="24%"><div align="left"><font size="2" color="#000080">加班奖金</font></div></td>
      <td width="20%"><div align="left"><font color="#000000" size="2"> </font><font size="2" color="#000000"><%=rs.getString(13)%>RMB</font></div></td>
      <td><div align="left"><font color="#000080" size="2">午餐补贴</font></div></td>
      <td><div align="left"><font size="2" color="#000000"><%=rs.getString(15)%>RMB</font></div></td>
    </tr>
    <tr> 
      <td width="24%"><div align="left"><font size="2" color="#000080">事假应加<font color="#000000">工资</font></font></div></td>
