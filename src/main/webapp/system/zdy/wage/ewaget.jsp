...
<form name="form1" method="post" action="do_ewage.jsp" onSubmit="return isValid();">  <br />
  <table width="100%" border="0" cellpadding="3" height="50">
    <tr>
      <td><div align="center"><font size="5"><font color="#213e9b"><strong>工 资 模 版</strong></font></font><font color="#000000" size="2">
