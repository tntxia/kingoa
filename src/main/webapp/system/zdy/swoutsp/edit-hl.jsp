...
String sql="select  * from  credit_debit_sp where id='"+id2+"'";
...
bordercolor="#CCBE5A" cellspacing="0" 
        ...
        <select size="1" name="dd_man">
          <%
		   String dd_man=rs.getString("dd_man").trim();
  				 try
            {
            ResultSet hlrs=infocrmdb.executeQuery("select name from username order by name asc");
            while(hlrs.next())
           {
    ...
    <tr bgcolor="#FFFFFF"> 
      <td width="14%" bgcolor="#e8ebf5"><font size="2" color="#000000">是否需要复审:</font>&nbsp;</td>
      ...
      <td bgcolor="#e8ebf5"><font size="2" color="#000000">复审者:</font>&nbsp;</td>
      <td><font size="2" color="#000000">
