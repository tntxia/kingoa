...
strSQL = "select count(*) from  credit_debit_sp";
...
strSQL = "select * from credit_debit_sp";
sqlRst = einfodb.executeQuery(strSQL);
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr> 
      <td height="6" colspan="3"><font color="#000000" size="2">往来帐目审批流程 &gt;&gt; 
        </font>&nbsp;</td>
      <td colspan="4" height="6"> <div align="right"><font color="#000000" size="2"> 
...
</font>&nbsp;</div></td></tr> <tr height="8" bgcolor="#d3d8eb"> <td width="126" height="8"> 
<div align="left" class="STYLE1"><font size="2">申请部门</font>&nbsp;</div></td>
<td width="151" height="8"> 
<div align="left" class="STYLE1"><font size="2">申请人职位</font>&nbsp;</div></td>
<td width="90" height="8"> 
<div align="left" class="STYLE1"><font size="2">审批人</font>&nbsp;</div></td>
<td width="127" height="8"> 
        <div align="left" class="STYLE1"><font size="2">是否复审</font>&nbsp;</div>      </td>
<td width="82" height="8"> 
<div align="left" class="STYLE1"><font size="2">复审人</font>&nbsp;</div></td>
<td width="98" height="8"> 
    <span class="STYLE2"><font size="2">添加</font><font size="2">日期</font></span></td>
<td width="121" height="8"> 
<div align="left" class="STYLE2"><font size="2">操作</font></div></td>
</tr> 
<%i = 0;
...
<td width="126" height="6"> <div align="left"><font size="2"><%=sqlRst.getString(2)%></font>&nbsp;</div></td><td width="151" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(3)%></font>&nbsp;</div></td><td width="90" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(4)%></font>&nbsp;</div></td><td width="127" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(5)%></font>&nbsp;</div></td><td width="82" height="6"> 
<div align="left"><font size="2"><%=sqlRst.getString(6)%></font>&nbsp;</div></td><td width="98" height="6"><font size="2"><%=sqlRst.getDate(8)%></font>&nbsp;</td><td width="121" height="6"> 
...
<%if(intPage>1){%> <a href="hlxx.jsp?page=<%=intPage-1%>" style="font-size: 12px">上一页</a> <% } %> </font>&nbsp;</div></td></tr> 
</table>
</form>
</body> <%sqlRst.close();}}%>
