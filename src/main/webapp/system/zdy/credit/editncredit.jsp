...
String sql="select * from credit_type where id='"+id1+"'";
...
bordercolor="#CCBE5A" cellspacing="0" 
    ...
    <TR BGCOLOR="#d3d8eb"> 
      <td width="20%"><font size="2" color="#000000">信用级别:</font>&nbsp;</td>
      <td colspan="2"> 
        <div align="left"><font size="2" color="#000000"> 
          <input type="text" name="cre_name" size="20" maxlength="30" value="<%=rs.getString("cre_name")%>">
          </font>&nbsp;</div>
      </td>
    </tr>
  </table>
