...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1">
    <TR BGCOLOR="#d3d8eb">
      <td width="20%" height="6"><font size="2" color="#000000">新建 &gt;&gt;</font>&nbsp;</td>
    ...
    <TR BGCOLOR="#d3d8eb"> 
      <td width="20%" bgcolor="#e8ebf5"><font size="2" color="#0000FF">单位自定义:</font>&nbsp;</td>
      <td colspan="2" bgcolor="#FFFFFF"> 
        <div align="left"><font size="2" color="#000000"> 
          <input type="text" name="punit_name" size="20" maxlength="30">
          </font>&nbsp;</div>
      </td>
    </tr>
  </table>
