...
String deptjb = (String) session.getValue("deptjb");
 ...
 if(zjview.equals("有")){
strSQL = "select count(*) from bank where deptjb like '"+deptjb+"%'";
}else
strSQL = "select count(*) from bank  where dept='"+dept+"'";
...
if(intPage>intPageCount) intPage = intPageCount;
 if(zjview.equals("有")){
strSQL = "select id,com_bank,bank,bank_num,dept,bank_je,bank_hb from bank where deptjb like '"+deptjb+"%'";
}
else
strSQL = "select id,com_bank,bank,bank_num,dept,bank_je,bank_hb from bank where dept='"+dept+"'";
sqlRst = einfodb.executeQuery(strSQL);
...
bordercolor="#CCBE5A" cellspacing="0" 
                        ...
                        border="1"><tr height="8" bgcolor="#d3d8eb"> <td width="20" height="8"><FONT COLOR="#000080" SIZE="2">#</font>&nbsp;</td>
      <td width="315" height="8"> 
        <div align="center"><FONT COLOR="#000080" SIZE="2">开户名称</font>&nbsp;</div>
      </td>
      <td width="194" height="8"> 
        <div align="center"><FONT COLOR="#000080" SIZE="2">开户银行</font>&nbsp;</div>
      </td>
      <td width="185" height="8" bgcolor="#D7E6FF"> 
        <div align="center"><FONT COLOR="#000080" SIZE="2">银行帐号</font>&nbsp;</div>
      </td>
      <td width="147" height="8"> 
        <div align="center"><font color="#000080" size="2">所属部门</font>&nbsp;</div>
      </td>
      <td width="104" height="8"> 
        <div align="center"><FONT SIZE="2" COLOR="#000080">余额</font>&nbsp;</div>
      </td>
    </tr>
    <%i = 0;
   while(i<intPageSize && sqlRst.next()){ int id=sqlRst.getInt(1);%>
    <tr height="8" onClick="window.open('view-hl.jsp?id=<%=id%>','rtop', 'height=432, width=955, top=50, left=50, toolbar=yes, menubar=no, scrollbars=yes, resizable=yes,location=no, status=no')" onMouseOver="this.bgColor='#B5DAFF'" onMouseOut="this.bgColor='#ffffff'" style="cursor:hand;"> 
      <td width="20" height="6"><FONT SIZE="2"><%=i+1%></font>&nbsp;</td>
      <td width="315" height="6"> 
...
double zje=0.00;
String strSQLpay="select l_sqje from credit_debit where g_bank='"+bank_name+"' and g_banknum='"+bank_num+"'  and  sy='client'";
...
double zjeg=0.00;
String strSQLg="select l_sqje from credit_debit where g_bank='"+bank_name+"' and g_banknum='"+bank_num+"' and  sy='supplier'";
...
%>
      ...
      <td width="147" height="6"><%=sqlRst.getString("dept")%></td>
      <td width="104" height="6"> 
        <div align="right"><FONT SIZE="2"><%=nf.format(tje)%><%=sqlRst.getString("bank_hb")%></font>&nbsp;</div>
      </td>
    </tr>
    <% i++; } %>
    <tr> 
