 ...
 public class WebUtils
 {
   ...
   public static boolean isNoLogin(HttpServletRequest request) { return !isLogin(request); }
   ...
   public static boolean isNoAdminLogin(HttpServletRequest request) { return !isAdminLogin(request); }
